...
// mesmo horário de trabalho (08:00 às 17:00, 8h de carga diária,
// com 1h de almoço no meio). Quando o projeto evoluir para jornadas
// diferentes por funcionário, isso vira um campo no banco em vez de
// uma constante fixa.
